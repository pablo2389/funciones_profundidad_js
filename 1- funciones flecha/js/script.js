...
function nombreCompleto(nombre, apellido) {
 ...
 console.log("declaracion de funcion como funcion flecha");
 const todoelnombre =(nombre, apellido) => {
    const completo = nombre + "_" +apellido;
    return completo;
 };
...
console.log("declaracion de funcion anonima como funcion flecha");
const primeras = (nombre,apellido) => {
    return nombre [0]. toUpperCase() +  "_" + apellido [0]. toUpperCase();
}
console.log(iniciales("Jean", "Grey"));
